...
const theme: EditorThemeDefinition = {
  ...
  rules: [
    ...
    {
      foreground: 'e4f0fbd0',
      token: 'source meta.function-call entity.name.function',
    },
    {
      foreground: 'e4f0fbd0',
      token: 'source meta.function-call entity.name.function',
    ...
    {
      foreground: 'e4f0fbd0',
      token: 'source meta.method-call entity.name.function',
    },
    {
      foreground: 'e4f0fbd0',
      token:
    ...
    {
      foreground: 'e4f0fbd0',
      token: 'meta.block meta.var.expr meta.function-call entity.name.function',
    },
    {
      foreground: 'e4f0fbd0',
    ...
    {
      foreground: 'e4f0fbd0',
      token: 'meta.property.class variable.other.class',
    },
    {
      foreground: 'e4f0fbd0',
    ...
    {
      foreground: 'add7ff',
      token: 'meta.class entity.name.class',
    },
    {
      foreground: 'add7ff',
    ...
    {
      foreground: 'add7ff',
      token: 'meta.class meta.function-call variable.function',
    },
    {
      foreground: 'add7ff',
